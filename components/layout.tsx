    ...
    <>
      ...
      <div className={styles.container}>
        <Head>
          ...
          <link
            rel="icon"
            href="https://static.ably.dev/motif-red.svg?ably-nextjs-fundamentals-kit"
            type="image/svg+xml"
          />
        </Head>
        <main className={styles.main}>
          <h1 className={styles.title}>
            <a href="https://ably.com/?utm_source=github&utm_medium=github-repo&utm_campaign=GLB-2211-ably-nextjs-fundamentals-kit&utm_content=ably-nextjs-fundamentals-kit&src=GLB-2211-ably-nextjs-fundamentals-kit-github-repo">
              Ably
            </a>{" "}
            &amp; <a href="https://nextjs.org">Next.js</a> fundamentals
          </h1>
